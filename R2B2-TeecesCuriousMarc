...
// Startup Text
char TFLDtext[] =  "       R2-BLUE2     "; //PUT YOUR TOP FRONT STARTUP TEXT HERE.
char BFLDtext[] =  "   BLUE CREW 6153   "; //PUT YOUR BOTTOM FRONT STARTUP TEXT HERE.
char RLDtext[] =   "BLUE CREW ROBOTICS  "; //PUT YOUR REAR STARTUP TEXT HERE.
...
#define RLDbrightness    1  //rear Logic
#define RPSIbrightness   15  //rear PSI
#define FLDbrightness    1   //front Logics
